...
#   --output_dir results/Longseq/order_4_llama/radius/$method/outputs/$lr/1-mnli\
...
#   --predict_with_generate \
#   --lora_dim $lora_rank \
#   --model_name_or_path results/Longseq/order_4_llama/radius/$method/outputs/$lr/1-mnli/adapter \
#   --data_dir CL_Benchmark \
#   --task_config_dir /home/qiuwenqi/LLM/Fedfinetune/FCL/adaLR/configs/SuperniAndLongseq/gen_script_long_order4_t5_configs/cb \
#   --output_dir results/Longseq/order_4_llama/radius/$method/outputs/$lr/2-cb \
#   --per_device_train_batch_size 16 \
#   --per_device_eval_batch_size 32 \
#   --gradient_accumulation_steps 2 \
#   --global_rounds 5 \
...
#   --predict_with_generate \
#   --lora_dim $lora_rank \
#   --model_name_or_path results/Longseq/order_4_llama/radius/$method/outputs/$lr/2-cb/adapter \
#   --data_dir CL_Benchmark \
#   --task_config_dir /home/qiuwenqi/LLM/Fedfinetune/FCL/adaLR/configs/SuperniAndLongseq/gen_script_long_order4_t5_configs/wic \
#   --output_dir results/Longseq/order_4_llama/radius/$method/outputs/$lr/3-wic \
#   --per_device_train_batch_size 16 \
#   --per_device_eval_batch_size 32 \
#   --gradient_accumulation_steps 2 \
#   --global_rounds 5 \
...
#   --predict_with_generate \
#   --lora_dim $lora_rank \
#   --model_name_or_path results/Longseq/order_4_llama/radius/$method/outputs/$lr/3-wic/adapter \
#   --data_dir CL_Benchmark \
#   --task_config_dir /home/qiuwenqi/LLM/Fedfinetune/FCL/adaLR/configs/SuperniAndLongseq/gen_script_long_order4_t5_configs/copa \
#   --output_dir results/Longseq/order_4_llama/radius/$method/outputs/$lr/4-copa \
#   --per_device_train_batch_size 16 \
#   --per_device_eval_batch_size 32 \
#   --gradient_accumulation_steps 2 \
#   --global_rounds 5 \
...
#   --predict_with_generate \
#   --lora_dim $lora_rank \
#   --model_name_or_path results/Longseq/order_4_llama/radius/$method/outputs/$lr/4-copa/adapter \
#   --data_dir CL_Benchmark \
#   --task_config_dir /home/qiuwenqi/LLM/Fedfinetune/FCL/adaLR/configs/SuperniAndLongseq/gen_script_long_order4_t5_configs/qqp \
#   --output_dir results/Longseq/order_4_llama/radius/$method/outputs/$lr/5-qqp \
#   --per_device_train_batch_size 16 \
#   --per_device_eval_batch_size 32 \
#   --gradient_accumulation_steps 2 \
#   --global_rounds 5 \
...
#   --predict_with_generate \
#   --lora_dim $lora_rank \
#   --model_name_or_path results/Longseq/order_4_llama/radius/$method/outputs/$lr/5-qqp/adapter \
#   --data_dir CL_Benchmark \
...
#   --output_dir results/Longseq/order_4_llama/radius/$method/outputs/$lr/6-boolq \
#   --per_device_train_batch_size 16 \
#   --per_device_eval_batch_size 32 \
#   --gradient_accumulation_steps 2 \
#   --global_rounds 5 \
...
#   --predict_with_generate \
#   --lora_dim $lora_rank \
#   --model_name_or_path results/Longseq/order_4_llama/radius/$method/outputs/$lr/6-boolq/adapter \
#   --data_dir CL_Benchmark \
#   --task_config_dir /home/qiuwenqi/LLM/Fedfinetune/FCL/adaLR/configs/SuperniAndLongseq/gen_script_long_order4_t5_configs/rte \
#   --output_dir results/Longseq/order_4_llama/radius/$method/outputs/$lr/7-rte \
#   --per_device_train_batch_size 16 \
#   --per_device_eval_batch_size 32 \
#   --gradient_accumulation_steps 2 \
#   --global_rounds 5 \
...
#   --predict_with_generate \
#   --lora_dim $lora_rank \
#   --model_name_or_path results/Longseq/order_4_llama/radius/$method/outputs/$lr/7-rte/adapter \
#   --data_dir CL_Benchmark \
#   --task_config_dir /home/qiuwenqi/LLM/Fedfinetune/FCL/adaLR/configs/SuperniAndLongseq/gen_script_long_order4_t5_configs/imdb \
#   --output_dir results/Longseq/order_4_llama/radius/$method/outputs/$lr/8-imdb \
#   --per_device_train_batch_size 16 \
#   --per_device_eval_batch_size 32 \
#   --gradient_accumulation_steps 2 \
#   --global_rounds 5 \
...
#   --predict_with_generate \
#   --lora_dim $lora_rank \
#   --model_name_or_path results/Longseq/order_4_llama/radius/$method/outputs/$lr/8-imdb/adapter \
#   --data_dir CL_Benchmark \
#   --task_config_dir /home/qiuwenqi/LLM/Fedfinetune/FCL/adaLR/configs/SuperniAndLongseq/gen_script_long_order4_t5_configs/yelp \
#   --output_dir results/Longseq/order_4_llama/radius/$method/outputs/$lr/9-yelp \
#   --per_device_train_batch_size 16 \
#   --per_device_eval_batch_size 32 \
#   --gradient_accumulation_steps 2 \
#   --global_rounds 5 \
...
#   --predict_with_generate \
#   --lora_dim $lora_rank \
#   --model_name_or_path results/Longseq/order_4_llama/radius/$method/outputs/$lr/9-yelp/adapter \
#   --data_dir CL_Benchmark \
...
#   --output_dir results/Longseq/order_4_llama/radius/$method/outputs/$lr/10-amazon \
#   --per_device_train_batch_size 16 \
#   --per_device_eval_batch_size 32 \
#   --gradient_accumulation_steps 2 \
#   --global_rounds 5 \
...
#   --predict_with_generate \
#   --lora_dim $lora_rank \
#   --model_name_or_path results/Longseq/order_4_llama/radius/$method/outputs/$lr/10-amazon/adapter \
#   --data_dir CL_Benchmark \
#   --task_config_dir /home/qiuwenqi/LLM/Fedfinetune/FCL/adaLR/configs/SuperniAndLongseq/gen_script_long_order4_t5_configs/sst2 \
#   --output_dir results/Longseq/order_4_llama/radius/$method/outputs/$lr/11-sst2 \
#   --per_device_train_batch_size 16 \
#   --per_device_eval_batch_size 32 \
#   --gradient_accumulation_steps 2 \
#   --global_rounds 5 \
...
#   --predict_with_generate \
#   --lora_dim $lora_rank \
#   --model_name_or_path results/Longseq/order_4_llama/radius/$method/outputs/$lr/11-sst2/adapter \
#   --data_dir CL_Benchmark \
...
#   --output_dir results/Longseq/order_4_llama/radius/$method/outputs/$lr/12-dbpedia \
#   --per_device_train_batch_size 16 \
#   --per_device_eval_batch_size 32 \
#   --gradient_accumulation_steps 2 \
#   --global_rounds 5 \
...
#   --predict_with_generate \
#   --lora_dim $lora_rank \
#   --model_name_or_path results/Longseq/order_4_llama/radius/$method/outputs/$lr/12-dbpedia/adapter \
#   --data_dir CL_Benchmark \
...
#   --output_dir results/Longseq/order_4_llama/radius/$method/outputs/$lr/13-agnews \
#   --per_device_train_batch_size 16 \
#   --per_device_eval_batch_size 32 \
#   --gradient_accumulation_steps 2 \
#   --global_rounds 5 \
...
CUDA_VISIBLE_DEVICES=1,2,3 accelerate launch --config_file script_accelerate/accelerate_config.yaml\
   ...
   --predict_with_generate \
   --lora_dim $lora_rank \
   --model_name_or_path results/Longseq/order_4_llama/radius/$method/outputs/$lr/13-agnews/adapter \
   --data_dir CL_Benchmark \
   ...
   --output_dir results/Longseq/order_4_llama/radius/$method/outputs/$lr/14-multirc \
   --per_device_train_batch_size 16 \
   --per_device_eval_batch_size 32 \
   --gradient_accumulation_steps 2 \
   --global_rounds 5 \
...
CUDA_VISIBLE_DEVICES=1,2,3 accelerate launch --config_file script_accelerate/accelerate_config.yaml\
   ...
   --predict_with_generate \
   --lora_dim $lora_rank \
   --model_name_or_path results/Longseq/order_4_llama/radius/$method/outputs/$lr/14-multirc/adapter \
   --data_dir CL_Benchmark \
   ...
   --output_dir results/Longseq/order_4_llama/radius/$method/outputs/$lr/15-yahoo \
   --per_device_train_batch_size 16 \
   --per_device_eval_batch_size 32 \
   --gradient_accumulation_steps 2 \
   --global_rounds 5 \
