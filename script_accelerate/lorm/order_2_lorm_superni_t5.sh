...
CUDA_VISIBLE_DEVICES=0,1,2 accelerate launch --config_file script_accelerate/accelerate_config.yaml\
   ...
   --predict_with_generate \
   --lora_dim $lora_rank \
   --model_name_or_path results/SuperNI/order_2_t5/$method/t5/outputs/$lr/1-task748_glucose_reverse_cause_event_detection/adapter \
   --data_dir CL_Benchmark \
...
CUDA_VISIBLE_DEVICES=0,1,2 accelerate launch --config_file script_accelerate/accelerate_config.yaml\
   ...
   --predict_with_generate \
   --lora_dim $lora_rank \
   --model_name_or_path results/SuperNI/order_2_t5/$method/t5/outputs/$lr/2-task073_commonsenseqa_answer_generation/adapter \
   --data_dir CL_Benchmark \
...
CUDA_VISIBLE_DEVICES=0,1,2 accelerate launch --config_file script_accelerate/accelerate_config.yaml\
   ...
   --predict_with_generate \
   --lora_dim $lora_rank \
   --model_name_or_path results/SuperNI/order_2_t5/$method/t5/outputs/$lr/3-task1590_diplomacy_text_generation/adapter \
   --data_dir CL_Benchmark \
...
CUDA_VISIBLE_DEVICES=0,1,2 accelerate launch --config_file script_accelerate/accelerate_config.yaml\
   ...
   --predict_with_generate \
   --lora_dim $lora_rank \
   --model_name_or_path results/SuperNI/order_2_t5/$method/t5/outputs/$lr/4-task639_multi_woz_user_utterance_generation/adapter \
   --data_dir CL_Benchmark \
...
CUDA_VISIBLE_DEVICES=0,1,2 accelerate launch --config_file script_accelerate/accelerate_config.yaml\
   ...
   --predict_with_generate \
   --lora_dim $lora_rank \
   --model_name_or_path results/SuperNI/order_2_t5/$method/t5/outputs/$lr/5-task1572_samsum_summary/adapter \
   --data_dir CL_Benchmark \
...
CUDA_VISIBLE_DEVICES=0,1,2 accelerate launch --config_file script_accelerate/accelerate_config.yaml\
   ...
   --predict_with_generate \
   --lora_dim $lora_rank \
   --model_name_or_path results/SuperNI/order_2_t5/$method/t5/outputs/$lr/6-task1687_sentiment140_classification/adapter \
   --data_dir CL_Benchmark \
...
CUDA_VISIBLE_DEVICES=0,1,2 accelerate launch --config_file script_accelerate/accelerate_config.yaml\
   ...
   --predict_with_generate \
   --lora_dim $lora_rank \
   --model_name_or_path results/SuperNI/order_2_t5/$method/t5/outputs/$lr/7-task591_sciq_answer_generation/adapter \
   --data_dir CL_Benchmark \
...
CUDA_VISIBLE_DEVICES=0,1,2 accelerate launch --config_file script_accelerate/accelerate_config.yaml\
   ...
   --predict_with_generate \
   --lora_dim $lora_rank \
   --model_name_or_path results/SuperNI/order_2_t5/$method/t5/outputs/$lr/8-task363_sst2_polarity_classification/adapter \
   --data_dir CL_Benchmark \
...
CUDA_VISIBLE_DEVICES=0,1,2 accelerate launch --config_file script_accelerate/accelerate_config.yaml\
   ...
   --predict_with_generate \
   --lora_dim $lora_rank \
   --model_name_or_path results/SuperNI/order_2_t5/$method/t5/outputs/$lr/9-task1510_evalution_relation_extraction/adapter \
   --data_dir CL_Benchmark \
...
CUDA_VISIBLE_DEVICES=0,1,2 accelerate launch --config_file script_accelerate/accelerate_config.yaml\
   ...
   --predict_with_generate \
   --lora_dim $lora_rank \
   --model_name_or_path results/SuperNI/order_2_t5/$method/t5/outputs/$lr/10-task1729_personachat_generate_next/adapter \
   --data_dir CL_Benchmark \
...
CUDA_VISIBLE_DEVICES=0,1,2 accelerate launch --config_file script_accelerate/accelerate_config.yaml\
   ...
   --predict_with_generate \
   --lora_dim $lora_rank \
   --model_name_or_path results/SuperNI/order_2_t5/$method/t5/outputs/$lr/11-task181_outcome_extraction/adapter \
   --data_dir CL_Benchmark \
...
CUDA_VISIBLE_DEVICES=0,1,2 accelerate launch --config_file script_accelerate/accelerate_config.yaml\
   ...
   --predict_with_generate \
   --lora_dim $lora_rank \
   --model_name_or_path results/SuperNI/order_2_t5/$method/t5/outputs/$lr/12-task511_reddit_tifu_long_text_summarization/adapter \
   --data_dir CL_Benchmark \
...
CUDA_VISIBLE_DEVICES=0,1,2 accelerate launch --config_file script_accelerate/accelerate_config.yaml\
   ...
   --predict_with_generate \
   --lora_dim $lora_rank \
   --model_name_or_path results/SuperNI/order_2_t5/$method/t5/outputs/$lr/13-task002_quoref_answer_generation/adapter \
   --data_dir CL_Benchmark \
...
CUDA_VISIBLE_DEVICES=0,1,2 accelerate launch --config_file script_accelerate/accelerate_config.yaml\
   ...
   --predict_with_generate \
   --lora_dim $lora_rank \
   --model_name_or_path results/SuperNI/order_2_t5/$method/t5/outputs/$lr/14-task1290_xsum_summarization/adapter \
   --data_dir CL_Benchmark \
