...
#   --output_dir results/Qwen2_gsm8k/lora_exp_observe_2/2200_20client_seed_42_abpair_naive_residual_maxage3 \
...
CUDA_VISIBLE_DEVICES=0,1,2,3 accelerate launch --config_file script_accelerate/accelerate_config.yaml\
   ...
   --data_dir /home/qiuwenqi/LLM/Third_work/data_gsm8k/gsm8k_uie_data \
   --task_config_dir /home/qiuwenqi/LLM/Third_work/data_gsm8k/gsm8k_uie_task_config \
   --output_dir results/Qwen2_gsm8k/lora_exp_observe_5/2200_20client_seed_42_abpair_naive_residual_50Gclient_maxage2 \
   --per_device_train_batch_size 16 \
   --per_device_eval_batch_size 16 \
   --gradient_accumulation_steps 2 \
   --global_rounds 5 \
